...
int do_ridebj() { do_ride("bj"); return 1; }
int do_rideca() { do_ride("ca"); return 1; }
int do_ridecd() { do_ride("cd"); return 1; }
int do_ridedl() { do_ride("dl"); return 1; }
int do_rideem() { do_ride("em"); return 1; }
int do_ridefs() { do_ride("fs"); return 1; }
int do_ridefz() { do_ride("fz"); return 1; }
int do_rideht() { do_ride("ht"); return 1; }
int do_ridehz() { do_ride("hz"); return 1; }
int do_ridelz() { do_ride("lz"); return 1; }
int do_rideqz() { do_ride("qz"); return 1; }
int do_ridesz() { do_ride("sz"); return 1; }
int do_ridewc() { do_ride("wc"); return 1; }
int do_ridewx() { do_ride("wx"); return 1; }
int do_ridexy() { do_ride("xy"); return 1; }
int do_rideyd() { do_ride("yd"); return 1; }
int do_rideyl() { do_ride("yl"); return 1; }
int do_rideyz() { do_ride("yz"); return 1; }
int do_ridekf() { do_ride("kf"); return 1; }
int do_rideyp() { do_ride("yp"); return 1; }
