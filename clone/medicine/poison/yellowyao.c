...
//		return notify_fail("你已經在找機會下手了！\n");
	...
	{
		int myskill = (me->query_skill("five_poison",1))*10+me->query("neili");
...
{
	this_player()->apply_condition("wugong_poison", (int)this_player()->query_condition("wugong_poison") + (int)ob->query("liquid/slumber_effect") );
	return 0;
}
