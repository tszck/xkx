...
void create()
{
	...
	set("inquiry", ([
		"鑄棍" : "師傅命我幫助別人鑄棍，但到現在也不見一個人影。誰要鑄棍呢？\n",
...
{	
	...
	{
		message_vision(HIC"師傅沒有同意為你鑄棍，您請回吧！\n"NOR, who);
		return 0;
	}
	...
	message("vision", "侍棍低頭檢視了一下手中的"+(string)ob->query("name")+"點了點頭説：\n", who);
	message("vision","。。。好我們現在就開始鑄棍！\n", who);
	write("請這位"+RANK_D->query_respect(who)+"給棍起名字吧！(zhu 棍的名字 英文代號)\n");
	destruct(ob);
	return 1;
}
#include "shi.c"