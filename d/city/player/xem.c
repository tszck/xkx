...
為人謙和沖淡，練功精益求精。峨嵋派由此得以發揚光
大。在江湖最險惡的時日裏，挺身而出，那脣邊的輕笑
如一縷春風，帶走人們心中肅殺的寒意。她，是一個神
話，至今仍在街巷酒肆中被人們傳誦。\n");
	set("title", HIW"聖人"HIG"明教地字門教眾"NOR"峨嵋派第四代弟子");
	set("age", 40);
	set("class", "bonze");
...
"【 神  尼 】翰林碩士明教地字門教眾峨嵋派第四代弟子 靜梅(Xem)\n"+
"\n"+
...
" 飲水：□□□□□□□□□□□□□□□□□□□□□□□□□\n"+
"\n"+
" 你到目前為止總共殺了 1593 個人，其中有 6 個是其他玩家。\n"+
"\n"+
" 你到目前為止總共死了 0 次了，其中有 0 次是非正常死亡。\n"+
"\n"+
" 正    氣：        0     潛    能：   0 (100%)   實戰經驗： 49927955\n"+
" 魅    力：       60     江湖閲歷：        0     江湖威望：       70\n"+
"\n", this_object());
	return 1;
}
