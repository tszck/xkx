...
" 飲水：■■■■■■■■■■■■■■■■■■■■■■■■■\n"+
"\n"+
" 到目前為止你總共殺了 7449 個人，其中有 2 個是其他玩家。\n"+
" 到目前為止你總共殺了 3 個同門，其中有 0 個是你的師長。\n"+
" 到目前為止你總共殺了 3 個幫中弟兄，其中有 0 個是你的上司。\n"+
" 到目前為止你總共殺了 3564 個無辜百姓，其中有 28 個是兒童。\n"+
" 到目前為止你總共死了 5 次了，其中有 3 次是非正常死亡。\n"+
" 到目前為止你總共叛師了 0 次了，被開除了 0 次。\n"+
"\n"+
" 戾    氣：  -802282     潛    能： 307 ( 99%)   實戰經驗：  1691661\n"+
" 魅    力：       60     江湖閲歷：    25236     江湖威望：       50\n"+
"\n", this_object());
	return 1;
}
...
int do_linqiyan()
{message_vision("$N説：小燕子阿，他是我在學校一起玩飛雪的兄弟了。他比他師兄影
楓可安靜多了，最不喜歡出風頭\n",this_object());
	return 1;
}

int do_baoer()
{message_vision("$N説：鈴の寶ル呀，她是我在泥潭中唯一心怡的人了，可惜初次認識時，
她已經有心上人了。唉，什麼時候才能再見到她啊....\n",this_object());
	return 1;
}

int do_yuki()
{message_vision("$N説：你説徐懷鈺啊，他可是我的老前輩。這傢伙的籃球技術可了不得，
籃板\n"+
...
int do_ftlsk()
{message_vision("$N説：凱子這傢伙，有事沒事就給我找麻煩。不過也沒辦法，誰叫我\n"+
