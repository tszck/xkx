...
void create()
{
	set_name("無情", ({ "wuqing"}));
	set("gender", "無性");
        set("long","本潭最早的玩家之一。性情豪爽，不拘小節，爲朋友
兩肋插刀，熱心扶助武林新人。曾和少林高僧渡天攜
手縱橫江湖十餘載，與各派高手均有不薄情誼。\n");
	set("title", HIY"翰林碩士"HIG"明教天字門教衆"HIR"明教護法"NOR);
	set("age", 48);
	set("class", "eunach");
...
"【曠世大俠】翰林碩士明教天字門教衆明教護法 無情(Wuqing)\n"+
"\n"+
...
" 飲水：□□□□□□□□□□□□□□□□□□□□□□□□□\n"+
"\n"+
" 你到目前爲止總共殺了 1151 個人，其中有 36 個是其他玩家。\n"+
"\n"+
