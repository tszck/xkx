...
void create ()
{
  set ("short", "入神坐照室");
  set ("long", @LONG
只見好大一間房中，除了一張石桌、兩隻石凳之外，空蕩蕩的一無
所有，石桌上刻着縱橫十九道棋路，對放着一盒黑子、一盒白子。靠窗
處茶几上放着一本棋書(book)和劉仲甫的《棋訣》(jue) ，有空可以讀
讀(read)看。這棋室中除了几椅棋子之外不設一物，當是免得對局者分
心。圍棋十訣雲：“貪不得勝  逢危須棄  入界宜緩  慎勿輕速  攻彼
顧我  動須相應  棄子爭先  彼強自保  舍小就大  勢孤取和”，你可
得小心了。
    牆上貼了一張小帖子(tie)。
LONG);
