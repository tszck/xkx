...
void create()
{
	...
	set("inquiry", ([
/*
		"風兒" : "大爺煩着呢，問什麼問！光長嘴巴沒長眼睛？\n",
		"winder" : "大爺煩着呢，問什麼問！光長嘴巴沒長眼睛？\n",
		"仙子" : "她是我老婆，你不知道？真是沒文化。\n",
		"java" : "她是我老婆，你不知道？真是沒文化。\n",
		"凡狗" : "凡狗不是好東西。我不過是騙錢而已。他簡直就是搶錢。\n",
		"fandog" : "凡狗不是好東西。我不過是騙錢而已。他簡直就是搶錢。\n",
		"降雪" : "噓，別問我小姑娘的事，java正在我背後站着呢。\n",
		"gladys" : "噓，別問我小姑娘的事，java正在我背後站着呢。\n",
*/
		"賭"   : "要賭就賭，和我羅嗦？沒空沒空。\n",
		"押牌" : "快押快押，先給錢再押。比磨蹭。\n",
	]) );
...
message_vision(HIR"牌童不屑一顧地看着$N，說道：要下注至少一兩銀子！\n"NOR,who);
			...
			if (ob->value()>200000)
			{
message_vision(HIR "牌童搖了搖頭，對$N說道：這裏不歡迎孤注一擲，最多下二十兩黃金。\n"NOR,who);
				return 0;
			}
			add("book_count",-1);
			thecash = ob->value();
