...
void create()
{
	...
	set("chat_chance", 3);
	set("chat_msg", ({
	"僕役突然説道: 魅力很重要，魅力值高可以進京當官。\n",
	"僕役得意的説: 等我魅力再高些了就去皇宮見皇上。\n",
	"僕役對丫環低聲説道: 我知道佛堂裏的祕密。\n",
	}));
        set("inquiry", ([
                "魅力" :  (: ask_meili :),
...
say("\n僕役説：如果你魅力值很高，出入官府都不會有人攔你。\n"
+"你還可以進宮去見皇上，如果他封你個官兒，你就可以帶兵啦 。。。。。\n");
say("僕役又説：不過當了官會有任務，搞不好會殺頭的。\n");
return 1;
}
...
say("僕役説道：地板下面有暗鎖，鑰匙在佛像左耳裏。\n");
say("僕役又説：貨真價實，不會騙你的。實在不行你回頭來找我。\n");
return 1;
}
say("僕役説道：幹什麼也得先交錢啊。\n");
say("僕役又説：我花了一年多時間才查到這件物事的所在，\n"+
"你這一萬兩銀子，可不是好賺的。\n");
return 1;
} 
