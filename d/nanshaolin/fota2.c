...
// string dir;
	if (arg=="今日大歡喜，舍卻危脆身")
	{
		write( "無色禪師的靈臺突然旋轉起來，發出隆隆聲響。一個聲音直透你心底，你甘願為我佛捨身嗎？\n");
...
int do_shenru()
{
	...
	if(me->query_temp("shen_said"))
	{
		...
		write("你身形一縱，十指如鈎，在禪臺邊上一抓要借力躍起。\n");
		message("vision", me->name()+"身形一縱，十指如鈎，在禪臺邊上一抓要借力縱起。\n", environment(me), ({me}) );
