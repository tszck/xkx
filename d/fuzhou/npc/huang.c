...
int accept_object(object who, object ob)
{
	...
	{
		message_vision(HIY"黃老先生對$N說：又給我錢？好！好！留着我喝老酒！\n"NOR , who);
		return 1;
	}
	...
	{
		message_vision(HIY "黃老先生對$N說：鏢車準備好了，在院子裏呢。趕快接鏢(jiebiao)吧！\n丟了鏢押金就賠償給鏢主！\n"NOR , who);
	...
	{
		message_vision(HIR"黃老先生皺着眉對$N說：就這點？你還保什麼鏢？出去出去！\n"NOR, who);
		return 0;
	}
}
...
{ 
	...
	{
message_vision(HIR"黃老先生皺着眉對$N說：那上面可是有好幾萬鏢銀啊！你要還想繼續保鏢就先交十兩黃金來吧！\n"NOR, me);
