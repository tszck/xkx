...
void create()
{
	...
	set("chat_chance", 10);
	set("chat_msg", ({
       "一名凌霄城弟子小聲説道：聽説老爺子發瘋了，還把封師叔的膀子卸了下來，不知道是真是假。\n", 
       "凌霄弟子冷笑道：打起來了好啊，這下子半年一次的論劍也不用開了，免得捱罵。\n", 
       "一名凌霄城弟子哼了一聲，道：師父一向説我們凌霄城的劍法天下無雙，改天我要讓那些江湖中人見識一下。\n",
       ...
       "一名凌霄城弟子看看四周，小聲説道：上次謝煙客來的時候，帶的那個狗雜種，聽説是長樂幫的幫主。\n",
       "一名凌霄城弟子擺了個架勢，大聲説：武當少林算什麼！老爺子説了，武林中就我們凌霄城最厲害！\n",
       "一名凌霄城弟子掏出一瓶酒，喝了兩口，紅着眼睛説：老爺子是被成師叔祖他們暗算了！我等會就去把他救出來！\n",
       "一名凌霄城弟子低聲對另一位弟子説，要想進地牢，就必須先拿到寒玉牌啊。\n",
       "一名凌霄城弟子憤憤説道：那個狗雜種，上次竟想對阿繡非禮，要是讓我遇見，哼哼哼！\n",
	}) );
	set_skill("strike", 50);
	set_skill("sword", 60);
	set_skill("force", 60);
...
void init()
{
	if( this_player()->query("family/master_id") == "bai zizai") {
		message_vision(HIC "凌霄弟子向$N躬身為禮，説道：師叔您老人家好！\n" NOR, 
		this_player());
	}       
}
