...
mapping *action = ({
([	"action" : "$N勢若瘋虎，形若邪魔，雙爪如鋼抓鐵鉤，左手手腕翻處，右手疾伸，五根手指抓向$n$l",
]),
...
([	"action" : "$N左手突然在$n眼前上圍下鉤，左旋右轉，連變了七八般，驀地裏右手一伸，五根手指直插$n$l",
]),
([	"action" : "$N雙掌不住地忽伸忽縮，手臂關節喀喇聲響，右掌一立，左掌啪的一下朝$n$l擊去",
]),
([	"action" : "$N身形挫動，風聲虎虎，接着朝$n連發八掌，一掌快似一掌，一掌猛似一掌",
]),
([	"action" : "$N攸地變爪爲掌，身子不動，右臂陡長，潛運內力，一掌朝$n$l劈去",
]),
...
//	tell_room(environment(me), 
  message_vision(
HIB"只見$N左手上圈下鉤、左旋右轉，連變了七八般花樣，驀地裏右手一伸，噗的
