...
void create()
{
	...
	set("chat_chance", 20);
	set("chat_msg", ({
	"莫聲谷輕聲説道：在石柱面壁可以大有收穫的。\n",
	"莫聲谷斜了你一眼：不過邪魔外道就不能面壁的了。\n",
	"莫聲谷自豪地説道：只有我武當才是天下的正宗。\n",
	"莫聲谷對張三豐的欽仰溢於言表：如果想成為絕頂高手，一定要學道德經。\n"
	"莫聲谷説道: 你知道江湖上的朋友為什麼都尊稱我們一聲武當七俠嗎？\n",
	"莫聲谷説道: 身為武當弟子應時時以俠義為先，你要切記啊！\n",
	"莫聲谷説道: 何為俠義之道？你自己好好想清楚吧。 \n",
	"莫聲谷説道: 青書那個畜生不知道躲哪去了，上次在峨嵋真不應該讓他逃掉。\n"
	"莫聲谷説道: 下次再見到青書一定不能讓他再跑了。 \n",
	}));
	set("inquiry", ([
		"繞指柔劍" : (: ask_me :),
		"raozhi"   : (: ask_me :),
