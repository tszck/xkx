...
void create()
{
	...
	"任盈盈緩緩說道：“咱們武林中人，只怕是註定要不得好死的了。他日後倘若對我負心，我也不盼望他天打雷劈，我……我……我寧可親手一劍刺死了他。”\n",
...
string ask_ling()
{
	...
	{
		message_vision("任盈盈又說道：這位"+ RANK_D->query_respect(me)+"，我已經派藍鳳凰去尋找了，也不知道怎麼樣了。\n",me);
		return "";
	}
	message_vision("任盈盈又說道：這位"+ RANK_D->query_respect(me)+"，我這裏有信，你要是找到令狐沖，就把信交給他，他會明白的。\n" , me);
...
int ask_tuijiao()
{
        ...
        {
		message_vision("盈盈淺淺一笑，對$N說道：你還沒加入我神教呢，就想退教？\n",ob);
		return 1;
        }
        if(ob->query("family/family_name") == "黑木崖" )
        {
	message_vision("盈盈抬起俏臉對$N說道：你已經是黑木崖弟子，如何能退教？\n", ob);
                return 1;
        }
